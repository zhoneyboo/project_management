	...
	<div id="health_mortalities">
	 	<div class="card rounded-0 bg-light mt-1 shadow-sm">
			<div class="card-body pl-4 pt-3 pb-3">
				<h5 class="font-weight-bold">Mortality: Leading Causes, Number and Rate per 100,000 Population Comparative Five Year Average</h5>
			</div>
		</div>
		<div class="row">
			<div class="col-md">
		...
		methods: {
			...
			updateInfo: function(){
				...
				axios.post('/social_development/health_mortalities/update', {data: vm.health_mortalities})
						.then(data => {
							vm.$toastr('success', 'Information is now updated!', 'Mortality: Leading Causes, Number and Rate per 100,000 Population Comparative Five Year Average')
							vm.getInfo(vm.year);
						})
			...
			addInfo: function(){
				...
				axios.post('/social_development/health_mortalities/create', vm.form)
						.then(data => {
							vm.$toastr('success', 'Information is now created!', 'Mortality: Leading Causes, Number and Rate per 100,000 Population Comparative Five Year Average')
							vm.getInfo(vm.year);
						})
			},
			deleteInfo: function(id){
				...
				axios.post('/social_development/health_mortalities/delete', {id: id})
						.then(data => {
							vm.$toastr('success', 'Information is now removed!', 'Mortality: Leading Causes, Number and Rate per 100,000 Population Comparative Five Year Average')
							vm.getInfo(vm.year);
						})
			}
		},
