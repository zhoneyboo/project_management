	...
	<div id="health_morbidities" >
	 	<div class="card rounded-0 bg-light mt-1 shadow-sm">
			<div class="card-body pl-4 pt-3 pb-3">
				<h5 class="font-weight-bold">Morbidity: Leading Causes, Number and Rate per 100,000 Population Comparative Five Year Average</h5>
			</div>
		</div>
		<div class="row">
			<div class="col-md">
...
<script>
	export default{
		...
		methods: {
			...
			updateInfo: function(){
				var vm = this;
				axios.post('/social_development/health_morbidities/update', {data: vm.health_morbidities})
						.then(data => {
							vm.$toastr('success', 'Information is now removed!', 'Morbidity: Leading Causes, Number and Rate per 100,000 Population Comparative Five Year Average')
							vm.getInfo(vm.year);
						})
			...
			addInfo: function(){
				...
				axios.post('/social_development/health_morbidities/create', vm.form)
						.then(data => {
							vm.$toastr('success', 'Information is now created!', 'Morbidity: Leading Causes, Number and Rate per 100,000 Population Comparative Five Year Average')
							vm.getInfo(vm.year);
						})
			},
			deleteInfo: function(id){
				var vm = this;
				axios.post('/social_development/health_morbidities/delete', {id: id})
						.then(data => {
							vm.$toastr('success', 'Information is now removed!', 'Morbidity: Leading Causes, Number and Rate per 100,000 Population Comparative Five Year Average')
							vm.getInfo(vm.year);
						})
